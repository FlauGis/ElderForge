...
namespace DialogueEditor
{
    ...
    public class ConversationManager : MonoBehaviour
    {
        ...
        public void StartConversation(NPCConversation conversation)
        {
            ...
            inventoryManager.UIBG.SetActive(true);
            inventoryManager.crossHair.SetActive(false);
            inventoryManager.bookActivatePanel.CloseMagicBook();
            Cursor.lockState = CursorLockMode.None;
            Cursor.visible = true;
            inventoryManager.playerRigidbody.constraints = RigidbodyConstraints.FreezeAll;
            inventoryManager.cameraController.canRotateCamera = false;
        ...
        public void EndConversation()
        {
            ...
            inventoryManager.cameraController.canRotateCamera = true;
            inventoryManager.UIBG.SetActive(false);
            inventoryManager.crossHair.SetActive(true);
            inventoryManager.playerRigidbody.constraints = RigidbodyConstraints.None;
            inventoryManager.playerRigidbody.constraints = RigidbodyConstraints.FreezeRotation;
